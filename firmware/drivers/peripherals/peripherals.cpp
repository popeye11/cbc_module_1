...
// }
void transmit_DAC_values(uint16_t dacvalues[2])
{
    CTRL_CHN1.transmit(dacvalues[0]); //  transmit adc value for debugging purpose
    CTRL_CHN2.transmit(dacvalues[1], CTRL_CHN2_NR);
}